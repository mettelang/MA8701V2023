...
```{r}
#| out.width: 100%"
include_graphics("../../Figures/Fig1Laan.jpg")
```
...
```{r}
#| out.width: 60%"
include_graphics("../../Figures/Fig31Polley.jpg")
```
...
```{r}
#| out.width: 100%"
include_graphics("../../Figures/SuperLearnerAlgo.png")
```
...
```{r}
#| out.width: 100%"
include_graphics("../../Figures/SuperLearnerMeta.png")
```

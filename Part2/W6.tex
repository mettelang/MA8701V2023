...
\NormalTok{hdires}\SpecialCharTok{$}\NormalTok{pval.corr}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{cbind}\NormalTok{(hdires}\SpecialCharTok{$}\NormalTok{lci, hdires}\SpecialCharTok{$}\NormalTok{uci)}
\end{Highlighting}
\end{Shaded}

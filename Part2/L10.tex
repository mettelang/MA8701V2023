...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cv.ridge}\OtherTok{=}\FunctionTok{cv.glmnet}\NormalTok{(}\AttributeTok{x=}\NormalTok{xss,}\AttributeTok{y=}\NormalTok{ys,}\AttributeTok{alpha=}\DecValTok{0}\NormalTok{,}\AttributeTok{standardize=}\ConstantTok{FALSE}\NormalTok{,}\AttributeTok{family=}\StringTok{"binomial"}\NormalTok{)}
\FunctionTok{print}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"The lamda giving the smallest CV error"}\NormalTok{,cv.ridge}\SpecialCharTok{$}\NormalTok{lambda.min))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"The 1sd err method lambda"}\NormalTok{,cv.ridge}\SpecialCharTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{cbind}\NormalTok{(}\FunctionTok{coef}\NormalTok{(ridgefit,}\AttributeTok{s=}\NormalTok{cv.ridge}\SpecialCharTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se),}\FunctionTok{coef}\NormalTok{(glm\_heart)))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{cv.lasso}\OtherTok{=}\FunctionTok{cv.glmnet}\NormalTok{(}\AttributeTok{x=}\NormalTok{xss,}\AttributeTok{y=}\NormalTok{ys,}\AttributeTok{alpha=}\DecValTok{1}\NormalTok{,}\AttributeTok{standardize=}\ConstantTok{FALSE}\NormalTok{,,}\AttributeTok{family=}\StringTok{"binomial"}\NormalTok{)}
\FunctionTok{print}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"The lamda giving the smallest CV error"}\NormalTok{,cv.lasso}\SpecialCharTok{$}\NormalTok{lambda.min))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
[1] "The lamda giving the smallest CV error 0.00903024338615681"
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{print}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"The 1sd err method lambda"}\NormalTok{,cv.lasso}\SpecialCharTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
[1] "The 1sd err method lambda 0.0481916929365089"
\end{verbatim}
...
{\centering \includegraphics{L10_files/figure-pdf/unnamed-chunk-9-2.pdf}
...
\CommentTok{\# use 1sd error rule default}
\FunctionTok{plot}\NormalTok{(lassofit,}\AttributeTok{xvar=}\StringTok{"lambda"}\NormalTok{,}\AttributeTok{label=}\ConstantTok{TRUE}\NormalTok{);}
\FunctionTok{abline}\NormalTok{(}\AttributeTok{v=}\FunctionTok{log}\NormalTok{(cv.lasso}\SpecialCharTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se));}
\end{Highlighting}
\end{Shaded}

\begin{figure}[H]

{\centering \includegraphics{L10_files/figure-pdf/unnamed-chunk-9-3.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{resmat}\OtherTok{=}\FunctionTok{cbind}\NormalTok{(}\FunctionTok{coef}\NormalTok{(lassofit,}\AttributeTok{s=}\NormalTok{cv.lasso}\SpecialCharTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se),}\FunctionTok{coef}\NormalTok{(ridgefit,}\AttributeTok{s=}\NormalTok{cv.ridge}\SpecialCharTok{$}\NormalTok{lambda}\FloatTok{.1}\NormalTok{se),}\FunctionTok{coef}\NormalTok{(glm\_heart))}
\FunctionTok{colnames}\NormalTok{(resmat)}\OtherTok{=}\FunctionTok{c}\NormalTok{(}\StringTok{"lasso logistic"}\NormalTok{,}\StringTok{"ridge logistic"}\NormalTok{,}\StringTok{"logistic"}\NormalTok{)}

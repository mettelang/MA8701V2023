...
subtitle: 'Part 5: Summing up and exam preparation'
...
* Learning outcomes
* Compulsory activities and final evaluation
* Final reading list
...
* Hyperparameter tuning: Bayesian optimization involves mainly knowledge of the multivariate normal distribution and the conditional version. 
* Comparision of results: Being able to translate the problem into a known statistical inference situation.
...
* Post selection inference is one cause for the reproducibility crises (overview level).
...
Interested in learning more about Bayesian nets? The arxiv article "Hands-on Bayesian Neural Networks - a Tutorial for Deep Learning Users" is readable <https://arxiv.org/pdf/2007.06823.pdf>. Other "Suggested reading" on course page reading list. 
...
```{r,eval=FALSE, out.width="80%",echo=FALSE}
#http://zevross.com/blog/2017/06/19/tips-and-tricks-for-working-with-images-and-figures-in-r-markdown-documents/
# options in r chunk settings
# out.width="100%"
# dpi=72
...
## Changes for MA8701 in V2025?

Please give feedback on my suggested changes and give general feedback to the reference group. 

Last meeting is May X. See contact detail so members at <https://wiki.math.ntnu.no/ma8701/2023v/start>

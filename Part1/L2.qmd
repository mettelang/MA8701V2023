...
# Plan
for this lecture (L2 in Part 1):

Continue with the decision theoretic framework from L1, but now for classification. If time also bias-variance trade-off.
...
* and the bias-variance trade-off (ELS 2.9 and 7.2-7.3)
...
1) What do we know about classification? (TMA4268 and TMA4315 mainly, or ELS ch 4.1-4.5, except 4.4.4)
...
(no solutions posted- MAKE!)

* for $k$NN in Equation 7.10 and 
* OLS in Equation 7.11 on pages 222-223.
...
https://www.math.ntnu.no/emner/TMA4315/2018h/3BinReg.html#grouped_vs_individual_data

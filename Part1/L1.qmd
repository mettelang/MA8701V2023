...
* Missing data ELS 9.6, Handbook of Missing data (parts of Chapters 11-12, partly 13) and Flexible Imputation of Missing Data (parts of Chapters 2-4)
...
## L1: notation, regression and statistical theoretic framework
...
## W2: L3-4: Then, cover new aspects for 
...
* How to handle missing data in data analyses (ELS 9.6), Handbook of Missing Data (Chapters 11-12-partly 13) and part of Chapters 2-4 from the Van Buuren (2018): Flexible Imputation of Missing Data.
...
More about training, test, validation, cross-validation and bootstrapping in ELS Chapter 7.
...
Both methods are written out in [these class notes from TMA4267/8](https://www.math.ntnu.no/emner/TMA4268/2018v/notes/LeastSquaresMLR.pdf).
